...
<head>
    ...
    * {
    ...
    <body>
        ...
        <hr>
        <div class="container">
          <form action="usersignmodproc.php" method="post">
            <div class="row">
              <div class="col-25">
            ...
            <div class="row">
				<button class="button button1" onclick="location.href='usermodproc.php'">submit</button>
            </div>
          </form>
		  		<div class="row">
					<button class="button button1" onclick="location.href='userremovesign.php'">Sign Drop</button>
				</div>
        </div>
    </body>
</html>
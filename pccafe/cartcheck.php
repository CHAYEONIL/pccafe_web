...
echo "</div>";
	...
	?>
		...
		<br>
		<br>
		<form action = "confirmcart.php" method ="get">
			<table id='common'>
				<tr>
					<th>주문 번호</th><th>음식 이름</th><th>가격</th><th>수량</th><th>삭제</th>
				...
				<tr>
					...
					<td><a href="removecart.php?id=<?= $row['id'] ?>" value class="btn"> 삭제 </a></td>
				</tr>
				<?php } ?>
			</table>
			<button type="sumbit"value class="btn"> 구입 </button>
		</form>
		<?php 
		    }
			else
